  ...
  return (
    ...
    >
        ...
        >
          <div className="flex gap-x-6">
            ...
            <div className="flex-1">
              <label htmlFor="jobTitle" className="block font-medium mb-1 text-left ml-1">
                Job Title
              </label>
              <input
                type="text"
            ...
            {/* Company Name */}
            <div className="flex-1">
              <label htmlFor="companyName" className="block font-medium mb-1 text-left ml-1">
                Company Name
              </label>
              <input
                type="text"
          ...
          <div className="flex gap-x-6">
            {/* Location */}
            <div className="flex-1">
              <label htmlFor="location" className="block font-medium mb-1 text-left ml-1">
                Location
              </label>
              <div
              ...
              >
                ...
                >
                  <span className={`font-medium text-base leading-none ${!formData.location ? 'text-gray-500' : 'text-gray-900'}`}>
            ...
            {/* Job Type Dropdown */}
            <div className="flex-1">
              <label htmlFor="jobType" className="block font-medium mb-1 text-left ml-1">
                Job Type
              </label>
              <div
              ...
              >
                ...
                >
                  <span className={`font-medium text-base leading-none ${!formData.jobType ? 'text-gray-500' : 'text-gray-900'}`}>
          ...
          <div className="flex gap-x-6">
            ...
            <div className="flex gap-x-4 w-1/2">
              <div className="flex-1">
                <label htmlFor="minSalary" className="block font-medium mb-1 text-left ml-1">
                  Salary Range
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="₹0"
                    className="w-full border border-gray-300 rounded px-8 py-2 appearance-none"
                    min="0"
                    required
                  />
              ...
              <div className="flex-1">
                <label htmlFor="maxSalary" className="block font-medium mb-1 text-white">
                  .
                </label>
                <div className="relative flex items-center border border-gray-300 rounded">
                  ...
                  <input
                    ...
                    className="w-full py-2 pl-1 pr-3 appearance-none text-left outline-none border-0"
                    min="0"
                    required
                  />
                </div>
            ...
            <div className="w-1/2">
              <label htmlFor="applicationDeadline" className="block font-medium mb-1 text-left">
              ...
              {/* CSS to hide the browser's default calendar icon */}
              <style jsx>{`
      ...
      `}</style>
          ...
          {/* Job Description */}
          <div className="mt-4">
            <label htmlFor="jobDescription" className="block font-medium mb-1 text-left ml-1">
              Job Description
            </label>
            <textarea
              id="jobDescription"
          ...
          <div className="flex justify-between items-center mt-6">
            <button
              type="button"
              onClick={saveDraft}
              className="flex items-center space-x-2 text-black-700 font-semibold transition-colors border-2 px-6 py-[16px] rounded-2xl"
            >
            ...
            <button
              type="submit"
              className="flex items-center space-x-2 bg-[#00AAFF] text-white font-semibold px-6 py-[16px] rounded-2xl"
            >
              <span>Publish</span>
