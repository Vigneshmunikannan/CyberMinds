  ...
  return (
    <>
      <nav className="relative w-[890px] h-[80px] mx-auto mt-[21px] rounded-[122px] bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] flex items-center justify-between px-6">
        ...
        <ul className="w-[838px] h-[48px] flex items-center justify-center ml-[-50px] space-x-8">
          <li className="cursor-pointer hover:text-[#8618DD] font-medium">Home</li>
          <li className="cursor-pointer hover:text-[#8618DD] font-medium">Find Jobs</li>
          <li className="cursor-pointer hover:text-[#8618DD] font-medium">Find Talents</li>
          <li className="cursor-pointer hover:text-[#8618DD] font-medium">About Us</li>
          <li className="cursor-pointer hover:text-[#8618DD] font-medium">Testimonials</li>
        </ul>

        <button
          className="bg-[#8618DD] text-white px-5 py-2 rounded-2xl whitespace-nowrap text-center font-medium cursor-pointer"
              ...
              {jobs.map(job => (
                ...
                >
                  ...
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="w-10 h-10 rounded-md overflow-hidden bg-white flex items-center justify-center shadow-md">
                      <img
                  ...
                  <div className="flex items-center flex-wrap text-sm text-gray-600 mb-3">
                    ...
                    <div className="flex items-center mr-2">
                      ...
                      <span className="whitespace-nowrap">₹ {(job.minSalary / 100000).toFixed(0)} LPA</span>
                    </div>
